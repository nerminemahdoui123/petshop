        ...
        <div className="bg-secondary-200 px-8 py-24">
            <div className="xl:w-[85%] mx-auto">
                ...
                <div className="flex justify-between mb-12">
                    ...
                    <p className="w-1/2 leading-relaxed text-[#795744]">.</p>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-8 text-center">
                    ...
                    <div className="flex flex-col items-center bg-[#c5a491] py-12 px-8 rounded">
                        ...
                        <p className="leading-relaxed text-[#5f4435]">offre the best quality of products to safepet</p>
                    </div>
                    ...
                    <div className="flex flex-col items-center bg-[#c5a491] py-12 px-8 rounded">
                        ...
                        <p className="leading-relaxed text-[#5f4435]">help clients and offre the best quality</p>
                    </div>
                    ...
                    <div className="flex flex-col items-center bg-[#c5a491] py-12 px-8 rounded">
                        ...
                        <p className="leading-relaxed text-[#5f4435]"> petshop is a company to offre pet products to your pets</p>
                    </div>
