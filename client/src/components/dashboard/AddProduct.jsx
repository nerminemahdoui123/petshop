        ...
        <div className="w-3/4">
          <form onSubmit={formik.handleSubmit}>
            ...
            <div className="flex flex-col space-y-1 mb-8">
              ...
              >
                <option value=""></option>
                <option value="desktop">selfcare</option>
                <option value="laptop">food</option>
                <option value="printer">medicament</option>
                <option value="scanner">autre</option>
                <option value="tablet">diversement</option>
                <option value="monitor">cloaths</option>
              </select>
